        ...
        <Container className="min-h-[100vh] py-10">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-3">
              <div className="h-[400px] md:h-[600px] overflow-hidden rounded-xl">
                <img
            ...
            <div className="space-y-4 px-3 sm:px-0">
              ...
              <p className="text-gray-600 font-semibold max-w-xl sm:text-base text-sm">
              ...
              <div className="flex items-center mt-2">
                {[...Array(5)].map((_, idx) => (
                  <Star
                    key={idx}
                    fill="yellow"
                    className="text-yellow-200 w-5 h-5"
                  />
                ))}
              ...
              <div className="flex items-center gap-2">
                <div className="bg-gray-200 text-gray-800 font-bold flex items-center gap-6 py-3 px-5 rounded-full">
                  ...
                  >
                    <Minus className="w-5 h-5 transition hover:text-gray-700" />
                  </span>
                  <span>{quantity}</span>
                  <span
                    onClick={() =>
                    ...
                    className="transition hover:text-gray-700 cursor-pointer"
                  >
                    <Plus className="w-5 h-5 transition hover:text-gray-700" />
                  </span>
                </div>
              ...
              <div className="my-5 space-x-4">
                <button
                  className="py-2 px-8 sm:px-12 border-2 rounded-full bg-green-800 font-bold text-white border-green-800 transition hover:bg-green-900"
                ...
                {isAddingToCart ? (
                  ...
                  <button
                    className="py-2 px-8 sm:px-12 border-2 rounded-full font-bold text-green-800 border-green-800 transition hover:bg-green-900 hover:text-white"
                    onClick={addToCartFunc}
                  >
                    Add to Cart
                  </button>
